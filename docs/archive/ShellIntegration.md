...
> - **Extra Content Covered Here:** Zsh, Bash, Fish configuration instructions, custom terminal keybindings, widget configuration details, and OSC theme-query hooks.
