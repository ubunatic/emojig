...
flowchart TD
    subgraph Offline / Build Time (Go)
        A["data/emoji.json (Raw Database)"] -->
> [!CAUTION]
> **This document has been archived.**
> - **Replaced by:** [WhyAndNiche.md](file:///home/uwe/projects/emojig/docs/WhyAndNiche.md)
> - **Extra Content Covered Here:** Extended comparative analysis of Go vs Zig, execution loop allocations, runtime GC latency explanations, and division of labor between `main.zig` and Go prep scripts.
> - **Outdated Information:** None.

---
 B["scripts/pack_emojis.go"]
