...
> - **Extra Content Covered Here:** Code file walkthrough detailing files under `src/` (`main.zig`, `root.zig`, `mru.zig`) and `scripts/` (`pack_emojis.go`, `test_tui.go`).
...
> [!NOTE]
> **Currency Status:** Current as of June 2, 2026. Matches the controls, performance metrics, and configuration options of **Emojig v0.1.5**.
