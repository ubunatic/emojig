...
> - **Extra Content Covered Here:** Detailed table comparing features between GUI Mockup (`emojig-idea-001.png`) and TUI implementation, layout structure sketches.
> - **Outdated Information:** Historical design planning phase.
