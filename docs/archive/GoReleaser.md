...
> - **Replaced by:** None (Deployment reference)
> - **Extra Content Covered Here:** Build pipeline configurations, goreleaser integration with GitHub/Codeberg, and target architectures mapping.
> - **Outdated Information:** Path references to pre-refactor source directories.

---
# GoReleaser Notes

> [!NOTE]
> **Currency Status:** Current as of June 2, 2026. Matches the active GoReleaser pipeline and compilation flags for **Emojig v0.1.5**.
