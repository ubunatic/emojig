...
> - **Replaced by:** None (Reference)
> - **Extra Content Covered Here:** Catalog of image and video previews and instructions on how to regenerate visual assets.
> - **Outdated Information:** Image links are now pointing to relocated paths.
...
![emojig GUI search in foot terminal](../media/emojig-5-foot-popup-over-zed-dark-v0.1.4.png)
![emojig GUI search in foot terminal](../media/emojig-5-foot-popup-over-zed-light-v0.1.4.png)
...
![emojig TUI results in Tilix](../media/emojig-4-tilix-tui-echo-cat-v0.1.4.png)
...
![emojig echo output in Ubuntu terminal](../media/emojig-3-ubuntu-echo-v0.1.4.png)
