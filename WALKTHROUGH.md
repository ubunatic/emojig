...
```bash
foot --app-id=emojig-picker --title="Emoji Picker" --window-size-chars=40x7 --override=font=monospace:size=14 --override=pad=12x8 zig-out/bin/emojig
```
...
bindsym Mod4+period exec foot --app-id=emojig-picker --title="Emoji Picker" --window-size-chars=40x7 --override=font=monospace:size=14 --override=pad=12x8 /absolute/path/to/emojig
```
...
bind = SUPER, period, exec, foot --app-id=emojig-picker --title="Emoji Picker" --window-size-chars=40x7 --override=font=monospace:size=14 --override=pad=12x8 /absolute/path/to/emojig
```
...
1. **Global Hotkey Setup**:
   ...
   * Set Command to:
     ```bash
     foot --app-id=emojig-picker --window-size-chars=40x7 --override=font=monospace:size=14 --override=pad=12x8 /absolute/path/to/emojig
     ```
