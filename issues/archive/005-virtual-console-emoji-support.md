...
**Status**: Closed — resolved (TERM=linux detection and diagnostic warning implemented; fbterm auto-spawn dropped by design to preserve zero-dependency architecture)
**Priority**: P3 (Low)
**Severity**: Minor
**Category**: Bug
**Related**: 007
