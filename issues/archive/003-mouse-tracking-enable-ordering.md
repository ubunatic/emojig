...
**Status**: Closed — resolved (terminal sequence emission reordered so mouse tracking enables only after raw mode is active and the restoration `defer` is registered)
**Priority**: P1 (High)
**Severity**: Major
**Category**: Bug
**Related**: —
