...
# 045 — ANSI escapes: `main.zig` still hand-rolls cursor/clear/mode sequences

**Status**: Closed — resolved (implemented; see "Resolution (2026-07-02)" below.
