...
-->
# 063 — two orphaned scratch scripts in `scripts/`: `test_posix.zig` and `gen_wayland_spec.go`

**Status**: Closed — resolved (deleted 2026-08-11)
**Priority**: P3 (Low) (housekeeping, no user-facing behavior; but both files are
