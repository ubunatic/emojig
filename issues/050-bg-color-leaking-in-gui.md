...
**Status**: Open — reopened 2026-08-08 (known implementation defects were fixed, but closed without an automated proof over the real rendered GUI)
**Priority**: P2 (Medium) (visual artifact in primary GUI mode)
**Severity**: Moderate
**Category**: Bug
**Related**: 048
...
`issues/050-bg-color-leaking-in-gui.png`.

## Annotated screenshot

See `issues/050-bg-color-leaking-in-gui.png` (red boxes mark leak sites).
...
Only after all of these checks pass may this issue return to `archive/`.
