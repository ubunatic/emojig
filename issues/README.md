...
| 064 | [064-update-fails-when-binary-still-open.md](064-update-fails-when-binary-still-open.md) | `emojig update` fails on systems that reject writes to a still-open binary | Open |
