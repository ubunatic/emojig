...
**Status**: Closed — resolved (review complete; findings filed as issues 25, 26, 27)
**Priority**: P2 (Medium)
**Severity**: Moderate
**Category**: Documentation
**Related**: 016, 020, 025, 026, 027
...
- `issues/002-distribution-and-release.md:356` says the installer path should download tarball + `SHA256SUMS`, verify the hash, then extract.
...
candidates to move into `issues/archive/` once you are happy with the archive.
