...
-->
# 056 — cache the foot color-theme dialect probe result in config; move it off the launch-blocking path

**Status**: Open
**Priority**: P3 (Low) (the probe it's caching is already cheap — ~5-7ms,
...
- Issue [53](archive/53-foot-grapheme-width-tweak.md) — where
