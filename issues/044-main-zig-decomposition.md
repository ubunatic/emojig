...
**Status**: In Progress
**Priority**: P2 (Medium) (readability/maintainability, not correctness)
**Severity**: Moderate
**Category**: Refactor
**Related**: 037, 043, 045, 046, 047, 048
...
See also [issue 45](archive/45-ansi-escape-consolidation.md) (raw ANSI escapes in
