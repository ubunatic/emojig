...
# 026 — `install.sh` and self-update still skip artifact verification
...
- `issues/002-distribution-and-release.md:356` — `Download tarball + SHA256SUMS, verify hash, extract emojig`
