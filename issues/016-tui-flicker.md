...
- The raw `"\x1b[2K\r"` literal is gone from `src/main.zig`. It is now the
  ...
  [45](archive/45-ansi-escape-consolidation.md)'s ANSI consolidation, not a
...
⚠️ Interacts with issue [45](archive/45-ansi-escape-consolidation.md)'s
