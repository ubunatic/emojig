...
# 027 — Config and MRU persistence still have silent 4 KB edge behavior

**Status**: Open
**Priority**: P2 (Medium)
**Severity**: Moderate
**Category**: Bug
**Related**: archive/001, 024
...
- `src/mru.zig:42-43` — `var file_buf: [4096]u8 = undefined;` +
  ...
  (was cited as `:31-32`)
- `issues/archive/001-config-file-silent-truncation.md:4` — old issue explicitly documents the earlier version of this same class of problem
...
This is a follow-on to [closed issue 01](archive/01-config-file-silent-truncation.md):
