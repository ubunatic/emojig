...
-->
# 057 — headless nested-sway canary shows a VS16 row-length defect that does NOT reproduce on the real desktop

**Status**: Open
**Priority**: P3 (Low) (downgraded 2026-08-09, final — the underlying bug this
...
- [x] Confirmed issue [53](archive/53-foot-grapheme-width-tweak.md)'s fix is
...
[issue 62](archive/62-move-font-width-experiments-to-fontwidth.md); run there via
...
- Issue [59](archive/59-canary-font-research-gaps.md) — the font-canary
...
- Issue [62](archive/62-move-font-width-experiments-to-fontwidth.md) — `canary_width_compare.zig`
...
- Issue [53](archive/53-foot-grapheme-width-tweak.md) — closed and confirmed
