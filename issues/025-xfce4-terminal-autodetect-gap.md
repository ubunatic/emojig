...
# 025 — GUI auto-mode misses `xfce4-terminal` despite built-in host support

**Status**: Open
**Priority**: P2 (Medium)
**Severity**: Moderate
**Category**: Bug
**Related**: 002, 046, 057, 060
...
- `issues/002-distribution-and-release.md` — backlog text still names
