...
-->
# 60 — `review_audit`'s `xfce-host-detect` check reports a false PASS after the host spec migration

**Priority: P2** (a repro tool that silently stops reproducing is worse than
